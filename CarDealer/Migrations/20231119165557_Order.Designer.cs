...
namespace CarDealer.Migrations
{
    ...
    [Migration("20231119165557_Order")]
    partial class Order
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarDealer.Entitys.OrderEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarDealer.Entitys.OrderEntity", b =>
                {
                    b.HasOne("CarDealer.Entitys.CarEntity", "Car")
                        .WithMany()
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarDealer.Entitys.CustomerEntity", "Customer")
                        .WithMany()
